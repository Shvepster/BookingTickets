...
public class EventController {
  ...
  @GetMapping("/all")
  @Operation(summary = "Все мероприятия (без пагинации)")
  @ApiResponses({
  ...
  @GetMapping("/search")
  @Operation(summary = "Простой поиск по названию")
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Успешно"),
      @ApiResponse(responseCode = "400", description = "Ошибка валидации параметров",
          content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
  })
  public List<EventResponseDto> searchByTitle(@RequestParam @NotBlank String title) {
