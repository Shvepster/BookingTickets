...
export function EventFormDialog({
    ...
    useEffect(() => {
        if (event) {
            ...
            if (event.eventDate) {
                // Форматируем строку для input type="datetime-local", заменяя пробел на T
                // Пример: "2025-12-31 20:00" -> "2025-12-31T20:00"
                setEventDate(event.eventDate.replace(" ", "T"));
            }
        } else {
            setTitle("");
            setPrice("");
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onSubmit({
            ...
            // Отправляем дату в локальном времени, просто добавив секунды
            // Пример: "2026-05-27T15:00" -> "2026-05-27T15:00:00"
